...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pago1 <-}\StringTok{ }\NormalTok{pago }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{t1 =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{index}\NormalTok{(pago)),}\DataTypeTok{factor_desc =} \DecValTok{1}\OperatorTok{/}\NormalTok{(}\DecValTok{1}\OperatorTok{+}\NormalTok{y}\OperatorTok{/}\DecValTok{2}\NormalTok{)}\OperatorTok{^}\NormalTok{(t1),}
                \DataTypeTok{val_present =}\NormalTok{ pago}\OperatorTok{*}\NormalTok{factor_desc) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{summarise}\NormalTok{(}\KeywordTok{sum}\NormalTok{(val_present)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{rename}\NormalTok{(}\StringTok{`}\DataTypeTok{Precio Bono}\StringTok{`}\NormalTok{ =}\StringTok{ `}\DataTypeTok{sum(val_present)}\StringTok{`}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# replicamos el objeto}
\NormalTok{pago2 <-}\StringTok{ }\NormalTok{pago}

\NormalTok{pago2}\OperatorTok{$}\NormalTok{t2 <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{rownames}\NormalTok{(pago2))}

\CommentTok{# Calculamos el factor de descuento}
\NormalTok{pago2}\OperatorTok{$}\NormalTok{factor_desc <-}\StringTok{ }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{y}\OperatorTok{/}\DecValTok{2}\NormalTok{)}\OperatorTok{^}\NormalTok{(pago2}\OperatorTok{$}\NormalTok{t2)}
\CommentTok{# Calculamos el valor presente}
\NormalTok{pago2}\OperatorTok{$}\NormalTok{val_present <-}\StringTok{  }\NormalTok{pago2}\OperatorTok{$}\NormalTok{factor_desc}\OperatorTok{*}\NormalTok{pago2}\OperatorTok{$}\NormalTok{pago}
\CommentTok{# Calculamos el precio}
\KeywordTok{sum}\NormalTok{(pago2}\OperatorTok{$}\NormalTok{val_present)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# p: valor nominal; tc: tasa cupón; t: madurez; y: yield to maturity}
\NormalTok{precio.bono <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(p,tc,t,y)\{}
\NormalTok{  pago   <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(tc}\OperatorTok{*}\NormalTok{p, t }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{),p}\OperatorTok{*}\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tc))}
\NormalTok{  pago   <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(pago)}
\NormalTok{  pago}\OperatorTok{$}\NormalTok{t <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{rownames}\NormalTok{(pago))}
\NormalTok{  pago}\OperatorTok{$}\NormalTok{factor_desc <-}\StringTok{ }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{y)}\OperatorTok{^}\NormalTok{(pago}\OperatorTok{$}\NormalTok{t)}
\NormalTok{  pago}\OperatorTok{$}\NormalTok{valor_prese <-}\StringTok{ }\NormalTok{pago}\OperatorTok{$}\NormalTok{factor_desc}\OperatorTok{*}\NormalTok{pago}\OperatorTok{$}\NormalTok{pago}
  \KeywordTok{sum}\NormalTok{(pago}\OperatorTok{$}\NormalTok{valor_prese)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Calaculamos el precio del bono para distintas yields}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(yields)) \{}
\NormalTok{  yields}\OperatorTok{$}\NormalTok{precio[i] <-}\StringTok{ }\KeywordTok{precio.bono}\NormalTok{(}\DecValTok{100}\NormalTok{, }\FloatTok{0.10}\NormalTok{, }\DecValTok{20}\NormalTok{, yields}\OperatorTok{$}\NormalTok{yields[i])  }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Graficamos con ggplot2}
\NormalTok{g1 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ yields,}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ yields}\OperatorTok{*}\DecValTok{100}\NormalTok{, }\DataTypeTok{y =}\NormalTok{ precio)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size =} \FloatTok{1.5}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{) }
\NormalTok{g1 <-}\StringTok{ }\NormalTok{g1 }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \DecValTok{3}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{)}
\NormalTok{g1 <-}\StringTok{ }\NormalTok{g1 }\OperatorTok{+}\StringTok{ }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Relación inversa:"}\NormalTok{, }\DataTypeTok{subtitle =} \StringTok{"Precio del Bono vs Yield"}\NormalTok{)}
\NormalTok{g1 <-}\StringTok{ }\NormalTok{g1 }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Yield (%)"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Precio del bono"}\NormalTok{) }
\NormalTok{g1 <-}\StringTok{ }\NormalTok{g1 }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ymax =} \KeywordTok{pmax}\NormalTok{(precio,}\DecValTok{0}\NormalTok{)), }\DataTypeTok{fill=}\StringTok{"pink"}\NormalTok{, }\DataTypeTok{col=}\StringTok{"red"}\NormalTok{, }\DataTypeTok{alpha=}\FloatTok{0.5}\NormalTok{) }
\NormalTok{g1 <-}\StringTok{ }\NormalTok{g1 }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }
\NormalTok{g1 <-}\StringTok{ }\NormalTok{g1 }\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{panel.border =} \KeywordTok{element_rect}\NormalTok{(}\DataTypeTok{colour =} \StringTok{"black"}\NormalTok{, }\DataTypeTok{fill =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{size =} \FloatTok{.5}\NormalTok{),}
...
{\centering \includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-45-1} 

}

\caption{Relación Bono vs Yield}\label{fig:unnamed-chunk-45}
\end{figure}
...
{\centering \includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-47-1} 

}

\caption{yield del tesoro de los Estados Unidos con chartSeries}\label{fig:unnamed-chunk-47}
\end{figure}

En caso que se quiera graficar usando \texttt{ggplot2}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{t10yr.df <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(t10yr)}

\NormalTok{t10yr.df <-}\StringTok{ }\NormalTok{t10yr.df }\OperatorTok{%>%}\StringTok{ }
\StringTok{            }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{fecha =} \KeywordTok{as.Date}\NormalTok{(}\KeywordTok{rownames}\NormalTok{(t10yr.df))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{            }\KeywordTok{na.omit}\NormalTok{()}

\NormalTok{g3 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ t10yr.df,}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ fecha , }\DataTypeTok{y =}\NormalTok{ DGS10)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size =} \DecValTok{1}\NormalTok{, }\DataTypeTok{color =} \StringTok{"green"}\NormalTok{)}
\NormalTok{g3 <-}\StringTok{ }\NormalTok{g3 }\OperatorTok{+}\StringTok{ }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"10-Year US Treasury Yields"}\NormalTok{, }\DataTypeTok{subtitle =} \StringTok{"Desde 2000-01-01 hasta 2018-04-17"}\NormalTok{)}
\NormalTok{g3 <-}\StringTok{ }\NormalTok{g3 }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Fecha"}\NormalTok{) }\OperatorTok{+}\KeywordTok{xlab}\NormalTok{(}\StringTok{"Yield(%)"}\NormalTok{) }
\NormalTok{g3 <-}\StringTok{ }\NormalTok{g3 }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{panel.border =} \KeywordTok{element_rect}\NormalTok{(}\DataTypeTok{colour =} \StringTok{"black"}\NormalTok{, }\DataTypeTok{fill =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{size =} \FloatTok{.5}\NormalTok{),}
                              \DataTypeTok{panel.grid.major =} \KeywordTok{element_line}\NormalTok{(}\DataTypeTok{colour =} \StringTok{"#d3d3d3"}\NormalTok{))}
\NormalTok{g3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Extraemos un valor en específico}
\NormalTok{t10yr_yield <-}\StringTok{ }\NormalTok{t10yr.df }\OperatorTok{%>%}\StringTok{ }
\StringTok{               }\KeywordTok{subset}\NormalTok{(fecha }\OperatorTok{==}\StringTok{ "2017-03-03"}\NormalTok{) }

\NormalTok{t10yr_yield <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(t10yr_yield}\OperatorTok{$}\NormalTok{DGS10)}\OperatorTok{*}\FloatTok{0.01}  
\end{Highlighting}
\end{Shaded}
